...
namespace NNPTPZ1.Mathematics.Tests
{
    ...
    public class ComplexNumberTest
    {
        ...
        public void AddTestPolynome()
        {
            ...
            poly.ComplexNumbers.Add(new ComplexNumber() { RealPart = 1, ImaginaryPart = 0 });
            poly.ComplexNumbers.Add(new ComplexNumber() { RealPart = 0, ImaginaryPart = 0 });
            poly.ComplexNumbers.Add(new ComplexNumber() { RealPart = 1, ImaginaryPart = 0 });
            ...
            var resultToString = poly.ToString();
            var expectedToString = "(1 + 0i) + (0 + 0i)x + (1 + 0i)xx";
            Assert.AreEqual(expectedToString, resultToString);
        }
    }
}
